let state = {
	sessions: [
	 	{
		id: 9,		// int  // race.id
		name: "FailistTulevSessioon",
		status: 'notStarted', 	// string "upcoming", "started", "finishing", "ended" // races.race1.status // NB! duplicate against hasStarted&isFinished
		startTimeStamp: 1775123702223,	// LocalDateTime // races.race9.startTimeStamp	// is this redundant? let's just use state.timer.startTime?
		secondsLeft: 100641 ,	// int milliseconds // races.race1.secondsLeft  // REVIEW @MARI - secondsLeft --> msLeft? // is this redundant?
		startTime: 1775123702223,		// LocalDateTime // races.race1.startTime // is this redundant? startTimeStamp or startTime?
